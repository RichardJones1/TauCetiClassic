...
/obj/structure/bookcase/manuals/xenoarchaeology/atom_init()
	. = ..()
	new /obj/item/weapon/book/manual/wiki/xenoarchaeology(src)
	new /obj/item/weapon/book/manual/wiki/xenoarchaeology_tools(src)
	new /obj/item/weapon/book/skillbook/engineering(src)
	new /obj/item/weapon/book/skillbook/robust(src)
	new /obj/item/weapon/book/skillbook/chemistry(src)
	update_icon()
